...
- **Esecuzione Condizionale (`&&`)**:
  - `git pull && npm install`: Esegui `npm install` solo se `git pull` ha successo.
- **Command Substitution (`$()`)**:
  - `nvim $(rg -l "TODO")`: Apri in `nvim` tutti i file che contengono "TODO".
- **Manipolazione File Essenziale**:
  - `cp sorgente dest`: Copia file. `cp -r` per le directory.
